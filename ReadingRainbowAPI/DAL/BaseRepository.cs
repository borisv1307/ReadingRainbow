...
namespace ReadingRainbowAPI.DAL
{
    ...
    where TEntity: Neo4jEntity, IEntity, new()
    {
        ...
        public virtual async Task<IEnumerable<Book>> GetJaccardWishList (Expression<Func<TEntity, bool>> query)
        {
        ...
        public virtual async Task<IEnumerable<Book>> GetJaccardLibrary (Expression<Func<TEntity, bool>> query)
        {
            string name1 = query.Parameters[0].Name;
